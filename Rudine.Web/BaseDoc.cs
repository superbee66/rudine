...
namespace Rudine.Web
{
    ...
    public class BaseDoc : DocProcessingInstructions, IBaseDoc
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Type> ListRelatedEntities() => ListRelatedEntities(GetType());
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        private List<Type> ListRelatedEntities(Type o) => o
            .GetProperties()
        ...
        /// <returns></returns>
        public PropertyInfo[] GetFormFillableProperties(bool filled = false) => GetFormObjectNavProperties(filled).Where(m => !FormNonFillablePropertyNames.Contains(m.Name)).ToArray();
