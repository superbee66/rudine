...
{
    internal static class PropertyDefaultValue
    {
        /// <summary>
        ...
        internal static bool IsDefaultValue(this object o, PropertyInfo Property, object PropertyValue = null) { return IsDefaultValue(o, Property.Name, PropertyValue); }
        ...
        /// <returns></returns>
        internal static bool IsDefaultValue(this object o, string PropertyName, object PropertyValue = null)
        {
            Type t = o.GetType();
