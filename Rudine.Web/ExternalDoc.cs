...
namespace Rudine.Web
{
    ...
    public class ExternalDoc : BaseDoc, IExternalDoc
    {
        ...
        public static readonly string SubmissionFileName = string.Format("{0}.dat", nameof(ExternalDoc));
        public static readonly string PropertiesFileName = string.Format("{0}.json", nameof(ExternalDoc));

        public static readonly string PIFileName = string.Format("{0}.json", "pi");
        //[ScriptIgnore]
