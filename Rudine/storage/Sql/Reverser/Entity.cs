...
using EnumMember = System.Data.Entity.Core.Metadata.Edm.EnumMember;
...
namespace Rudine.Storage.Sql.Reverser
{
    ...
    internal class Entity : EntityBase
    {
        ...
        public class CodeGenerationTools
        {
            ...
            ///     setting.
            /// </summary>
            public string Escape(Type clrType) => Escape(clrType, FullyQualifySystemTypes);
            ...
            {
                return itemCollection.GetItems<GlobalItem>().Where(i => i is EntityType || i is ComplexType || i is System.Data.Entity.Core.Metadata.Edm.EdmType || i is EntityContainer).Select(g => GetGlobalItemName(g));
            }
            ...
            public string GetTypeName(TypeUsage typeUsage) => typeUsage == null ? null : GetTypeName(typeUsage.EdmType, _ef.IsNullable(typeUsage), null);
            ...
            /// <returns>The type name to use.</returns>
            public string GetTypeName(EdmType edmType) => GetTypeName(edmType, null, null);
            ...
            /// </param>
            /// <returns>The type name to use.</returns>
            public string GetTypeName(TypeUsage typeUsage, string modelNamespace) => typeUsage == null ? null : GetTypeName(typeUsage.EdmType, _ef.IsNullable(typeUsage), modelNamespace);
            ...
            /// </param>
            /// <returns>The type name to use.</returns>
            public string GetTypeName(EdmType edmType, string modelNamespace) => GetTypeName(edmType, null, modelNamespace);
            ...
            private string GetTypeName(EdmType edmType, bool? isNullable, string modelNamespace)
            {
                ...
                string typeName = Escape(edmType.MetadataProperties
                                      ...
                                      .FirstOrDefault())
                                  ??
                                  (modelNamespace != null && edmType.NamespaceName != modelNamespace ? CreateFullName(EscapeNamespace(edmType.NamespaceName), Escape(edmType)) : Escape(edmType));
            ...
            /// </summary>
            public string SpaceAfter(string value) => StringAfter(value, " ");

            /// <summary>
            ///     If the value parameter is null or empty an empty string is returned,
            ///     otherwise it retuns value with a single space concatenated on the end.
            /// </summary>
            public string SpaceBefore(string value) => StringBefore(" ", value);
        ...
        public class CodeRegion
        {
                ...
                : this(textTransformation)
            {
                ...
                CurrentIndentLevel = firstIndentLevel - 1;
            }
            ...
            ///     at
            /// </summary>
            public int CurrentIndentLevel { get; private set; } = -1;
            ...
            public void Begin(string regionName, int levelsToIncreaseIndent)
            {
                ...
                CurrentIndentLevel += levelsToIncreaseIndent;
                _textTransformation.Write(GetIndent(CurrentIndentLevel));
            ...
            {
                int indentLevel = CurrentIndentLevel;
                CurrentIndentLevel -= levelsToDecrease;
        ...
        public class DynamicHost : IDynamicHost
        {
            ...
            /// </summary>
            public IServiceProvider AsIServiceProvider() => _instance as IServiceProvider;

            /// <summary>
            ///     A call to Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost ResolveParameterValue
            /// </summary>
            public string ResolveParameterValue(string id, string name, string otherName) => (string) _resolveParameterValue.Invoke(_instance, new object[] {id, name, otherName});

            /// <summary>
            ///     A call to Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost ResolvePath
            /// </summary>
            public string ResolvePath(string path) => (string) _resolvePath.Invoke(_instance, new object[] {path});
        ...
        public class DynamicTextTransformation
        {
            ...
            /// </summary>
            public CompilerErrorCollection Errors => (CompilerErrorCollection) _errors.GetValue(_instance, null);

            /// <summary>
            ///     Gets the value of the wrapped TextTranformation instance's GenerationEnvironment property
            /// </summary>
            public StringBuilder GenerationEnvironment => (StringBuilder) _generationEnvironment.GetValue(_instance, null);
        ...
        public class EntityFrameworkTemplateFileManager
        {
            ...
            protected bool IsFileContentDifferent(string fileName, string newContent) => !(File.Exists(fileName) && File.ReadAllText(fileName) == newContent);
        ...
        public class MetadataLoader
        {
            ...
            /// </summary>
            public bool TryCreateEdmItemCollection(string sourcePath, out EdmItemCollection edmItemCollection) => TryCreateEdmItemCollection(sourcePath, null, out edmItemCollection);
            ...
            private class EdmItemCollectionBuilder : ItemCollectionBuilder
            {
                ...
                /// </summary>
                protected override string GetNamespace(SchemaConstants constants) => constants.CsdlNamespace;
            }
            ...
            private abstract class ItemCollectionBuilder
            {
                ...
                protected ItemCollectionBuilder(DynamicTextTransformation textTransformation, string fileExtension, string edmxSectionName, string rootElementName)
                {
                    ...
                    EdmxSectionName = edmxSectionName;
                ...
                /// </summary>
                public string EdmxSectionName { get; }
            ...
            private class StorageMappingItemCollectionBuilder : ItemCollectionBuilder
            {
                ...
                protected override ItemCollection CreateItemCollection(IEnumerable<XmlReader> readers, out IList<EdmSchemaError> errors) => MetadataItemCollectionFactory.CreateStorageMappingItemCollection(_edmItemCollection, _storeItemCollection, readers, out errors);

                /// <summary>
                ///     Selects a namespace from the supplied constants.
                /// </summary>
                protected override string GetNamespace(SchemaConstants constants) => constants.MslNamespace;
            }
            ...
            private class StoreItemCollectionBuilder : ItemCollectionBuilder
            {
                ...
                protected override ItemCollection CreateItemCollection(IEnumerable<XmlReader> readers, out IList<EdmSchemaError> errors) => MetadataItemCollectionFactory.CreateStoreItemCollection(readers, out errors);

                /// <summary>
                ///     Selects a namespace from the supplied constants.
                /// </summary>
                protected override string GetNamespace(SchemaConstants constants) => constants.SsdlNamespace;
            }
        }
        ...
        public class MetadataTools
        {
            ...
            /// </summary>
            public Type ClrType(TypeUsage typeUsage) => UnderlyingClrType(typeUsage.EdmType);
            ...
            /// </summary>
            public bool IsNullable(EdmProperty property) => property != null && IsNullable(property.TypeUsage);
        ...
        public class NullHost : IDynamicHost
        {
            ...
            ///     Returns null.
            /// </summary>
            public IServiceProvider AsIServiceProvider() => null;
            ...
            /// </summary>
            public string ResolveParameterValue(string id, string name, string otherName) => null;
