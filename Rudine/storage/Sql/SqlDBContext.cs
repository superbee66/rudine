    ...
    public abstract class SqlDbContext : DbContext
    {
        ...
        public static SqlDbContext CreateInstance(BaseDoc _BaseDoc)
        {
            ...
            namespace {0} {{
                public class {1} : {2}.{3} {{
                    public {1}() : base( ) {{
                        System.Data.Entity.Database.SetInitializer(new System.Data.Entity.MigrateDatabaseToLatestVersion<{0}.{1},{5}.{4}<{0}.{1}>>());
                    }}
                }}
            }}",
                ...
                nameof(SqlDbContext),
                nameof(SqlDbMigrationsConfiguration<DbContext>),
