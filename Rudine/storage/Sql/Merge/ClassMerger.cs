...
namespace Rudine.Storage.Sql.Merge
{
    ...
    public class ClassMerger
    {
        ...
        public int CalcClassSignature(string nameSpace, Type[] sourceTypes, string newClassName = null, string[] PropertyNameExclutions = null, bool prettyNames = true, Type BaseType = null) => new ClassSignature(
            nameSpace,
        ...
        private ClassProperty[] ConsolidatePropertyNames(string nameSpace, Type[] sourceTypes = null, string[] propertyNameExclutions = null, Type BaseType = null, bool prettyNames = true, ClassProperty[] ClassProperties = null)
        {
            ...
            foreach (ClassProperty _ClassProperty in
        ...
        {
            ClassProperty[] _ConsolidatePropertyNames = ConsolidatePropertyNames(
                nameSpace,
                null,
                propertyNameExclutions,
                baseType,
        ...
        private static string pretty(string Name) => StringTransform.PrettyMsSqlIdent(Name);
        private static string pretty(ClassProperty _ClassProperty) => pretty(_ClassProperty.Name);
    }
}