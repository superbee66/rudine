...
<xsl:stylesheet version="1.0" xmlns:my="http://schemas.microsoft.com/office/infopath/2003/myXSD/2017-04-25T02:31:05" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xd="http://schemas.microsoft.com/office/infopath/2003" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:xdExtension="http://schemas.microsoft.com/office/infopath/2003/xslt/extension" xmlns:xdXDocument="http://schemas.microsoft.com/office/infopath/2003/xslt/xDocument" xmlns:xdSolution="http://schemas.microsoft.com/office/infopath/2003/xslt/solution" xmlns:xdFormatting="http://schemas.microsoft.com/office/infopath/2003/xslt/formatting" xmlns:xdImage="http://schemas.microsoft.com/office/infopath/2003/xslt/xImage" xmlns:xdUtil="http://schemas.microsoft.com/office/infopath/2003/xslt/Util" xmlns:xdMath="http://schemas.microsoft.com/office/infopath/2003/xslt/Math" xmlns:xdDate="http://schemas.microsoft.com/office/infopath/2003/xslt/Date" xmlns:sig="http://www.w3.org/2000/09/xmldsig#" xmlns:xdSignatureProperties="http://schemas.microsoft.com/office/infopath/2003/SignatureProperties" xmlns:ipApp="http://schemas.microsoft.com/office/infopath/2006/XPathExtension/ipApp" xmlns:xdEnvironment="http://schemas.microsoft.com/office/infopath/2006/xslt/environment" xmlns:xdUser="http://schemas.microsoft.com/office/infopath/2006/xslt/User" xmlns:xdServerInfo="http://schemas.microsoft.com/office/infopath/2009/xslt/ServerInfo">
	<xsl:output method="html" indent="no"/>
	<xsl:template match="my:INFOPATH2013">
		<html>
			<head>
						...
						<tbody>
							...
							<tr class="xdTableContentRow">
								<td vAlign="top" class="xdTableContentCell">
									...
									<div><span title="" class="xdTextBox" hideFocus="1" tabIndex="0" xd:binding="my:field1" xd:CtrlId="CTRL1" xd:xctname="PlainText" style="WIDTH: 100%">
											<xsl:value-of select="my:field1"/>
										</span>
									</div>
									<div>Rich Text Box<span title="" class="xdRichTextBox" hideFocus="1" tabIndex="0" xd:binding="my:field2" xd:CtrlId="CTRL2" xd:xctname="RichText" style="HEIGHT: 50px; WIDTH: 100%">
											<xsl:copy-of select="my:field2/node()"/>
										</span>Drop-Down List Box<select title="" class="xdComboBox xdBehavior_Select" size="1" tabIndex="0" xd:binding="my:field3" xd:CtrlId="CTRL3" xd:xctname="dropdown" xd:boundProp="value" style="WIDTH: 100%">
											...
											<xsl:if test="function-available('ipApp:GetMajorVersion') and ipApp:GetMajorVersion() &gt;= 12">
												...
												<span xd:xctname="PlainText" hideFocus="1" class="xdTextBox xdBehavior_ComboBoxTextField" title="" tabIndex="0" xd:binding="my:field4" xd:CtrlId="CTRL4">
											...
											<select title="" class="xdComboBox xdBehavior_Select" size="1" xd:binding="my:field4" xd:CtrlId="CTRL4" xd:xctname="dropdown" xd:boundProp="value">
												<xsl:choose>
									...
									<div><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:binding="my:field5" xd:CtrlId="CTRL5" xd:xctname="CheckBox" xd:boundProp="xd:value" xd:onValue="true" xd:offValue="false">
									...
									<div>
										...
										<div>Option1<input title="" class="xdBehavior_Boolean" type="radio" value="" name="{generate-id(my:field6)}" tabIndex="0" xd:binding="my:field6" xd:CtrlId="CTRL6" xd:xctname="OptionButton" xd:boundProp="xd:value" xd:onValue="1">
												<xsl:attribute name="xd:value">
										...
										<div>Option2<input title="" class="xdBehavior_Boolean" type="radio" value="" name="{generate-id(my:field6)}" tabIndex="0" xd:binding="my:field6" xd:CtrlId="CTRL7" xd:xctname="OptionButton" xd:boundProp="xd:value" xd:onValue="2">
												<xsl:attribute name="xd:value">
													<xsl:value-of select="my:field6"/>
												</xsl:attribute>
										...
										<div>Option3<input title="" class="xdBehavior_Boolean" type="radio" value="" name="{generate-id(my:field6)}" tabIndex="0" xd:binding="my:field6" xd:CtrlId="CTRL8" xd:xctname="OptionButton" xd:boundProp="xd:value" xd:onValue="3">
												<xsl:attribute name="xd:value">
													<xsl:value-of select="my:field6"/>
												</xsl:attribute>
